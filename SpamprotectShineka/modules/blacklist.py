...
from SpamprotectShineka import SPAM_LOG_CHANNEL, SUDOERS, SpamprotectShineka
from SpamprotectShineka.modules.info import get_info
from SpamprotectShineka.utils.db import (add_chat, add_user, blacklist_chat,
