...
from SpamprotectShineka import SUDOERS, SpamprotectShineka
...
@ShinSpamProtectbot [CHAT_ID/Username|USER_ID/Username]
"""
...
@SpamprotectShineka.on_message(filters.command("info"), group=3)
...
@SpamprotectShineka.on_inline_query()
