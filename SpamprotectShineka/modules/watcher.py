...
from SpamprotectShineka import SUDOERS, arq, SpamprotectShineka
from SpamprotectShineka.utils.db import (add_chat, add_user, chat_exists,
                          is_chat_blacklisted, is_nsfw_downvoted,
                          is_nsfw_enabled, is_spam_enabled,
                          is_user_blacklisted, update_spam_data,
                          user_exists)
from SpamprotectShineka.utils.functions import (delete_nsfw_notify,
                                 delete_spam_notify, kick_user_notify)
from SpamprotectShineka.utils.misc import admins, get_file_id, get_file_unique_id


@SpamprotectShineka.on_message(
    (
        filters.document
        | filters.photo
        | filters.sticker
